...
// add_action('pagelines_before_branding_icons', 'add_address');
  ...
  add_action('pagelines_inside_bottom_content', 'add_social');
    ...
    echo '<div class="social">Follow us on<br />
		<div class="social-icons"><a href="https://www.facebook.com/cabvi1929" target="_blank"><img src="http://www.cabvi.org/wp-content/uploads/2015/08/facebook.png" /></a>
		</div><div class="social-icons"><a href="https://www.linkedin.com/company/1334720" target="_blank"><img src="http://www.cabvi.org/wp-content/uploads/2015/08/linkedin.png" /></a>
		</div></div>';
}